...
def create_squeezenet_ssd_lite(num_classes, is_test=False):
    ...
    regression_headers = ModuleList([
        SeperableConv2d(in_channels=512, out_channels=1 * 5, kernel_size=3, padding=1), # 6*4
        SeperableConv2d(in_channels=512, out_channels=1 * 5, kernel_size=3, padding=1), # 6*4
        SeperableConv2d(in_channels=512, out_channels=1 * 5, kernel_size=3, padding=1), # 6*4
        SeperableConv2d(in_channels=256, out_channels=1 * 5, kernel_size=3, padding=1), # 6*4
        SeperableConv2d(in_channels=256, out_channels=1 * 5, kernel_size=3, padding=1), # 6*4
        Conv2d(in_channels=256, out_channels=1 * 5, kernel_size=1),                     # 6*4
    ])

    classification_headers = ModuleList([
        SeperableConv2d(in_channels=512, out_channels=1 * num_classes, kernel_size=3, padding=1), # 6
        SeperableConv2d(in_channels=512, out_channels=1 * num_classes, kernel_size=3, padding=1), # 6
        SeperableConv2d(in_channels=512, out_channels=1 * num_classes, kernel_size=3, padding=1), # 6
        SeperableConv2d(in_channels=256, out_channels=1 * num_classes, kernel_size=3, padding=1), # 6
        SeperableConv2d(in_channels=256, out_channels=1 * num_classes, kernel_size=3, padding=1), # 6
        Conv2d(in_channels=256, out_channels=1 * num_classes, kernel_size=1),                     # 6
    ])
