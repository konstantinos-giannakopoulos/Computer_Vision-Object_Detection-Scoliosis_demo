...
from .config import resnet_ssd600_config as config
...
def create_resnet50_ssd600(num_classes, is_test=False):
...
def create_resnet50_ssd600_predictor(net, candidate_size=200, nms_method=None, sigma=0.5, device=None):
